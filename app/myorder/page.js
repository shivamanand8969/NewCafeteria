...
const myorder = async () => {
  ...
  // let orderdatacount=data1.data.map((value)=>(value._id==id?5:0))
  
    return (
  <>
  <Header/>
  <div className=' bg-slate-950 mt-14 '>
    {/* {(orderdatacount.length>=1)? */}
     <h1 className='text-white text-3xl text-center py-2'>Your Order Item</h1>
     {/* :<h1 className='text-white  text-3xl text-center py-2 '>Order Empty ! Please Something Order</h1> */}
