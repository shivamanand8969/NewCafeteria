    ...
    return (
        <header className='bg-blue-800 fixed top-0 left-0 w-full z-50 text-white font-sans'>
            ...
            <nav className='max-sm:hidden container bg-blue-800 relative h-14 flex justify-between items-center '>
                ...
                <div ref={ref} className='absolute top-0 right-0 bg-pink-200 px-8 py-10 text-black transform transition-transform translate-x-full '>
                    <h2 className='font-bold text-xl'>Shopping Cart</h2>
                    <span onClick={toglecart} className='absolute top-5 right-2 cursor-pointer text-2xl' ><AiFillCloseCircle /></span>
                    <ol>
                        <li>
                            <div className='item flex my-5'>
                                <div className='w-2/3 font-semibold'>Buger </div>
                                <div className='flex font-semibold items-center justify-center w-1/3'><span><AiOutlineMinusCircle className='text-red-500 cursor-pointer m-1' /></span><span>1</span><span><AiOutlinePlusCircle className='text-red-500 cursor-pointer m-1' /></span></div>
                            </div>
                        </li>
                        <li>
                            <div className='item flex my-5'>
