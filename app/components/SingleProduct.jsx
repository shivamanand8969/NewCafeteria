  ...
  <div className="container px-5 py-16 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h2 className="text-sm title-font lg:text-2xl text-white tracking-widest">
          {name}
        </h2>
        <h1 className="text-white text-3xl title-font font-medium mb-1">
          <span className='text-bold text-black text-xl mr-2 '> ₹ </span> {price}
        </h1>
        ...
        <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
          ...
          <div className="flex ml-6 items-center">
            ...
            <div className="relative">
             <input type='number' value={quantity} className='h-9 w-36 border-2 px-2 border-black' placeholder='Quantity..'/>
